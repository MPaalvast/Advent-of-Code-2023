...
class Config2022Fixtures extends Fixture implements FixtureGroupInterface, DependentFixtureInterface
{
...
//        $this->fixtureService->makeGameDays($manager, $year, $gameDays, $dayParts);
    ...
    {
//        yield ['day' => $this->getReference('day_1', Day::class), 'title' => "Calorie Counting", 'status' => StatusEnum::INACTIVE];
